...
export const SiteDetailsPage: React.FC = () => {
    ...
    const availableUsers = users.filter((user) => !site?.editors?.some((editor) => editor.id === user.id));
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex items-center justify-between">
                <div>
                    <Button variant="ghost" onClick={() => navigate('/admin/sites')} className="mb-2 p-0 h-auto text-slate-500">
                        ← Back to Sites
                    </Button>
                ...
                <div className="flex gap-2">
                    ...
                    <Button variant="secondary" onClick={() => setIsDeleteModalOpen(true)} className="text-red-600 hover:bg-red-50 hover:text-red-700">
                        Delete Site
                    </Button>
                </div>
            </div>
